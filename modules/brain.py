...
_SYSTEM = (
    ...
    "Der 'titel' ist der öffentliche YouTube-Videotitel. MAXIMAL 35 ZEICHEN — kürzer ist besser.\n"
    "Kurz, umgangssprachlich, neugierig-machend. Klingt wie etwas das ein Freund sagt, nicht wie ein Lehrbuch.\n"
    "VERBOTEN: Fachbegriff in Klammer (z.B. 'Wie X funktioniert (Fachbegriff)'). "
    "VERBOTEN: Erklärtitel ('Wie der X-Bias deine Y verzerrt'). "
    "VERBOTEN: 'Der/Die/Das [Fachbegriff]' allein. VERBOTEN: mehr als 35 Zeichen.\n"
    "Top-Performer-Beispiele (20-25 Zeichen, hohe Views): "
    "'Das weiß fast niemand.' · 'Das klingt illegal.' · 'Sparmodus Körper' · "
    "'Das merkt kaum jemand.' · 'Dein Gehirn lügt dich an.'\n"
    "Formel: kurze Behauptung oder Cliffhanger, kein Fachbegriff, kein Erklärton.\n\n"
    ...
    "TEXT-BINDUNG — ABSOLUT PFLICHT:\n"
    "Bevor du einen einzigen Prompt schreibst: Lies Hook und Text des Shorts genau durch. "
    "Identifiziere die konkreten Objekte, Personen, Orte und Handlungen die im Text vorkommen. "
    "Jeder Prompt MUSS eine dieser konkreten Elemente zeigen — keine freie Erfindung.\n"
    "Beispiel Text 'Du ziehst um, voller Aufregung': Prompt zeigt Umzugskartons, leere Wohnung, neuen Schlüssel — NICHT eine lächelnde Frau im Büro.\n"
    "Beispiel Text 'Anker lenkt dein Denken': Prompt zeigt Preisschilder, Marktstand, Verhandlung — NICHT abstrakte Felsen.\n"
    "VERBOTEN: Prompts die zu einem anderen Short passen würden. Wenn du dir nicht sicher bist ob ein Prompt zu DIESEM Text gehört — ändere ihn.\n\n"

    "CHRONOLOGISCHE PFLICHT:\n"
    "Die Bildreihenfolge folgt dem gesprochenen Voiceover — keine Rückblenden, keine Vorgriffe. "
    "BODY A zeigt ausschließlich, was in Satz 1 des Textes passiert. "
    "BODY B zeigt ausschließlich, was in Satz 2/3 des Textes passiert. "
    "VERBOTEN: Ein Bild zeigt ein Ereignis, das erst später gesprochen wird.\n\n"

    "EMOTIONALER SUBTEXT — nur als Verstärker:\n"
    "Die konkrete Szene aus dem Text ist Pflicht. Innerhalb dieser Szene: "
    "verstärke die Emotion durch Lichtstimmung, Kamerawinkel, Details — aber erfinde keine neue Szene. "
    "Frage für jeden Prompt: 'Zeigt dieses Bild eine Situation die im Text direkt vorkommt?' "
    "Wenn nein → neu schreiben.\n\n"
...
_SYSTEM_DEDUP = (
    ...
    "Titel MAXIMAL 35 Zeichen, kurz und umgangssprachlich wie 'Das weiß fast niemand.' — "
    "KEIN Fachbegriff in Klammer, KEIN Erklärtitel, KEIN Wikipedia-Stil. "
